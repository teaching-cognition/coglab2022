...
- Tuesdays and Sundays, 7-9 pm, Kanbar 200
...
#library(data.table)
library(readxl)
Lectures <- read_excel("coglab_2023_schedule.xlsx", sheet = 1, col_names = TRUE, col_types = NULL, na = "", skip = 0)
...
Grades will be determined based on the following rubric, which is based on emphasizing our [three learning goals](#why-take-this-course-a.k.a.-learning-goals) (<span style="color:#508AB0">Design</span>, <span style="color:#E7AC10">Analyze</span> and <span style="color:#1CB447">Communicate</span>)
...
| Component        | Points  | 
|:------------------|:-------| 
| [Weekly quizzes](#weekly-quizzes-25-points) |     25  | 
| [Formative assignments](#formative-assignments-30-points)      |      30  | 
| [Final project](#final-project-40-points)     |       40 | 
| [Class participation](#class-participation-5-points)      |      5  | 
...
There will be several formative low-stakes milestones during the semester to ensure you are making steady progress towards the final project. Details about the project milestones are available [here](https://docs.google.com/document/d/1rIEw_j5BbU3sO_9TThJDCtl68QdCMIO1/edit?usp=sharing&ouid=114230382498081849934&rtpof=true&sd=true).
...
3. <u> Win Star Coder (1 point)</u>: You will submit 4 formative coding assignments during the semester. The two students who score the combined highest score on these assignments will earn 1 extra credit each.

2. <u> Win Team Player (1 point) </u>: For each project milestone, your teammates will  submit self and peer evaluations based on how the work was divided among the team members. The two students who receive the overall highest peer evaluation score at the end of the semester will earn 1 extra credit each.
...
**Use of ChatGPT**: We will learn a lot of new concepts (some technical and some non-technical) during this course. ChatGPT is a large language model that can be viewed as a helper/assistant, and is often useful in troubleshooting and/or idea generation. To that end, you are allowed to use ChatGPT to debug code or generate ideas for your research proposal. I have found that ChatGPT is useful in breaking down complex parts of content and explaining them to beginners in easy ways. Having said that, it is not always reliable so exercise caution and always USE YOUR OWN JUDGMENT, even if you take suggestions from ChatGPT or other sources on the internet. Further, please acknowledge/cite ChatGPT/other sources when and if you use it in your assignments or project work.
