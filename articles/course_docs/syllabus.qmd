...
| Milestone | Points       |
|:-------------|:------------|
| 1: Team plan + articles            | 2 |
| 2: QALMRI + proposal               | 2 |
| 3: Anatomy                         | 1 |
| 4: Design draft                    | 1 |
| 5: Full Experiment                 | 5 |
| 6: Pre-registration                | 5 |
| 7: Inferential Analyses            | 5 |
| 8: Poster draft                    | 2 |
...
##### Milestone 1: Team Plan + Articles (2 points)

This assessment will happen relatively early in the semester. You will be expected to submit a document where you have discussed a plan for your project as well as selected some preliminary articles that you will be reading to develop the idea for your study.

##### Milestone 2: QALMRI + proposal

This assessment will help you consolidate your ideas and research into an informal research proposal. You will first write QALMRIs for 6 research articles that your team has collectively read and reviewed, and then based on the QALMRIs, submit a jointly written 5-page literature review and proposal for your study. Note that your study must be a conceptual extension of the main study we will be replicating in class. 

##### Milestone 3: Anatomy

This assessment will help you understand the concrete elements of your research design. You will be required to submit a detailed mock-up of your experiment, including the stimuli and phases that you envision your experiment to contain. 
